    ...
    <div className="space-y-6">
      ...
      {data.activities.length === 0 ? (
        <DataUnavailable
          ...
          reason="מתחמי gov.il ואתרי המשרדים חסומים על ידי רשימת ההיתר של סביבת הבנייה, ולכן API הפרסומים הרשמי לא היה נגיש. לא נוצרו פריטים משוחזרים או מנוסחים ללא מקור. הפירוט המלא, כולל יומן ניסיונות האיסוף, מופיע במסך המתודולוגיה."
        />
      ) : (
        <>
          <Card>
