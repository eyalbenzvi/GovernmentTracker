      ...
      <section aria-labelledby="not-collected-heading">
        ...
        <Callout tone="caution">
          ...
          <p>
            ...
            רשומה מצוינת שיטת החילוץ — כולל סימון מפורש כאשר הרשומה פוענחה ב-OCR מסריקה ועשויה להכיל
            שגיאות תעתיק. קבצים שלא ניתן היה לקרוא מוצגים ברשימה נפרדת עם הסיבה, ולא שוחזרו בניחוש.
          </p>
        </Callout>
      </section>
