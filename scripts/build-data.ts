    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'מה לא נכלל בנתוני התקציב: מלבד תקציב הפיתוח, אינם נכללים גם סעיפי המפעלים העסקיים (למשל בתי החולים הממשלתיים), שירות החוב, והרזרבה הכללית. כל אחד מהם הוא סעיף נפרד בתקציב המדינה, ואף אחד מהם אינו נושא את שם המשרד — ולכן שיוכו למשרד היה ניחוש.',
          'המשמעות המעשית, ויש להבין אותה לפני קריאת כל מספר באתר: המספרים כאן הם התקציב הרגיל של הסעיף בלבד, ולא סך ההוצאה הציבורית בתחום. בכמה תחומים — תחבורה ובינוי בראשם — התקציב הרגיל הוא חלק קטן מן ההוצאה, ותקציב הפיתוח גדול ממנו בהרבה. האתר אינו מציג את היקפו של החלק החסר ואינו אומד אותו; מי שנדרש לתמונה המלאה יבדוק את סעיפי הפיתוח ישירות במפתח התקציב, שכל רשומה כאן מקשרת אליו.',
