...
export const dataVersionSchema = z.object({
  ...
  counts: z.object({
    ...
    ministerTenuresEnded: z.number().int().min(0),
...
export const diaryInsightsSchema = z.object({
  ...
  profiles: z.array(
    z.object({
      ...
      fridayMeetingCount: z.number().int().min(0),
      saturdayMeetingCount: z.number().int().min(0),
      weekendNonMeetingCount: z.number().int().min(0),
